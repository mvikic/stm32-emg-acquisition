...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
    // Transmit ADC data over USART in a circular buffer fashion
//	HAL_UART_Transmit(&huart2, (uint8_t*)adc_buffer, ADC_BUFFER_SIZE * 2, HAL_MAX_DELAY);
//	HAL_Delay(10); // Adjust delay as necessary for plotter speed
  }
  /* USER CODE END 3 */
}
